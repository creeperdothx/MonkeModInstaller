...
namespace MonkeModManager
{
    public partial class FormMain : Form
    {
        ...
        private void LoadRequiredPlugins()
        {
            ...
            UpdateStatus("Successfully fetched latest version info!");
        ...
        private void CheckVersion()
        {
            ...
            Int16 version = Convert.ToInt16(DownloadSite("https://raw.githubusercontent.com/CreeperLogMat/MonkeModManager/master/update.txt"));
            if (version > CurrentVersion)
            {
                this.Invoke((MethodInvoker)(() =>
                {
                    ...
                    Process.Start("https://github.com/CreeperLogMat/MonkeModManager/releases/latest");
                    Process.GetCurrentProcess().Kill();
                    Environment.Exit(0);
                }));
            }
